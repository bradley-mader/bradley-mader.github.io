...
export const homeDescription = 'I am an Agentic Backend Software Engineer focused on building reliable, verifiable and efficient solutions to developing performant software. With over 8 years of experience developing Full-Stack and Backend Applications, I believe code generated by LLMs under strict Software Engineering best practices will shift the economics of software to provide tailored software that more intimately mirrors real user demands. I have worked on multiple projects to improve and implement backend services with engineered agentic pipelines focusing on rigidly engineered context and validation loops as well as presented research findings to enterprise leadership.';
