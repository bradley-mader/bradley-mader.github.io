        ...
        return (
            <Banner>
                <ProfileContainer> 
                    ...
                    <DescriptionText className='text-primary m-font center-justified' width="100%"><img src="./Psych_Skills.png" alt="GO | Kubernetes | PostgresQL | AWS | Azure"/></DescriptionText>
                </ProfileContainer>
            </Banner>
        );
    }
